                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-3 pb-5">
                                ...
                                <form action="{{ route('login') }}" method="POST" class="md-form">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        <input type="email" id="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" autocomplete="email">
                                        <label class="form-label" for="email" id="emailLabel">Email</label>
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <input type="password" id="password" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror" autocomplete="current-password"/>
                                    ...
                                    <p class="small mb-2 pb-lg-2"><a class="text-white-50" href="{{ route('password.request') }}">{{ __('Forgot Your Password?') }}</a></p>
                            ...
                            <div>
                                <p class="mb-0">{{__("Don't have an account")}}? <a href="{{ route('register') }}" class="text-white-50 fw-bold">{{ __('Register') }}</a>
                                </p>
                            </div>
